...
## :rocket: Updates
* Inspired by the example in SA3D, we tried our Referring Video Segmentation on NERF Examples and works well :)
...
* Try our [Video Demo (Beta)](https://24485a8a48fe6c01.gradio.app) (also integrated to [Hugging Face Demo](https://huggingface.co/spaces/xdecoder/SEEM)) on referring video object segmentation.
<p float="left">
